...
class ComentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coment" do
    assert_difference('Coment.count') do
      post coments_url, params: { coment: { comment: @coment.comment, movie_id: @coment.movie_id } }
    end
  ...
  test "should update coment" do
    patch coment_url(@coment), params: { coment: { comment: @coment.comment, movie_id: @coment.movie_id } }
